...
String expectedPrefix = "ARG KNOX_VERSION=";
    ...
    for (String line : lines) {
      ...
      if (line.startsWith(expectedPrefix)) {
        ...
        if (expectedVersion.equals(value)) {
          ...
          throw new IllegalArgumentException("Expected Knox version of " + expectedVersion + " but got " + value);
        }
      }
    }

    throw new IllegalArgumentException("Could not extract Knox version from " + dockerfile);
}
