...
public class AuditLayout extends AbstractStringLayout {
  ...
  private static final DateFormat DATE_FORMATTER = new SimpleDateFormat("yy/MM/dd HH:mm:ss", Locale.getDefault());
  ...
  public String toSerializable(LogEvent event) {
    ...
    sb.append( message.equals("null") ? "" : message ).append( System.lineSeparator() );
    return sb.toString();
  }
}
