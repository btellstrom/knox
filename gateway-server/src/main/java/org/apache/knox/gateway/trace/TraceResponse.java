...
class TraceResponse extends HttpServletResponseWrapper {
  ...
  private static Logger log = LogManager.getLogger( TraceHandler.HTTP_RESPONSE_LOGGER );
  private static Logger headLog = LogManager.getLogger( TraceHandler.HTTP_RESPONSE_HEADER_LOGGER );
