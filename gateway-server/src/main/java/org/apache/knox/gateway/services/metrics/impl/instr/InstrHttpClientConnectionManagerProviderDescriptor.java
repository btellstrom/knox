...
public class InstrHttpClientConnectionManagerProviderDescriptor implements
    InstrumentationProviderDescriptor {

  private HashMap<Class<?>, InstrumentationProvider> providers;

  public InstrHttpClientConnectionManagerProviderDescriptor() {
    providers = new HashMap<>();
    providers.put(ConnectionManagerBuilder.class, new InstrHttpClientConnectionManagerProvider());
  }
